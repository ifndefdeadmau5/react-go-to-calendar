...
var useCalendar = (options = {}) => {
  ...
  const [cursor, setCursor] = (0, import_react.useState)(initialDateCursor.startOf("week"));
  ...
  const dividedByMonth = (0, import_react.useMemo)(() => chunk(days, 7).reduce((acc, week) => {
