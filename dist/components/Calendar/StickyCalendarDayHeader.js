...
var StickyCalendarDayHeader_exports = {};
__export(StickyCalendarDayHeader_exports, {
  default: () => StickyCalendarDayHeader_default
});
module.exports = __toCommonJS(StickyCalendarDayHeader_exports);
...
var StickyCalendarDayHeader = ({ scrollContainerId, ...props }, ref) => {
  const calendarHeaderRef = (0, import_react6.useRef)(null);
  const [node2, setNode] = (0, import_react6.useState)(null);
  const observer = (0, import_react6.useRef)(null);
...
var StickyCalendarDayHeader_default = (0, import_react6.forwardRef)(StickyCalendarDayHeader);
 ...
 * LICENSE file in the root directory of this source tree.
 */
//# sourceMappingURL=StickyCalendarDayHeader.js.map