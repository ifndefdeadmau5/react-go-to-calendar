...
module.exports = __toCommonJS(Calendar_stories_exports);
...
// src/components/Calendar/CalendarDayHeader.tsx
var dayNumberStyle = ({ showYear }) => css`
  padding: 1px 0px;
  border-radius: 14px;
  ${showYear && css`
...
var YearMonth = ({
  ...
  css: css`
    ...
    `,
  ...others
}, /* @__PURE__ */ React.createElement("span", null, datetime.toFormat("yyyy"), "-"), /* @__PURE__ */ React.createElement("span", null, datetime.toFormat("MM")));
var CalendarDayHeader = ({
  date,
  highlight = false,
  weekend = false,
  showYear = false,
  ...
  const startOfMonth = findStartOfMonth({ date: startOfWeek, range: 7 });
  ...
  return /* @__PURE__ */ React.createElement("div", {
    ...
    css: css`
      ...
      `,
    ...others
  }, showYear && startOfMonth ? /* @__PURE__ */ React.createElement(YearMonth, {
    className: "CalendarDay-yearMonth",
    datetime: startOfMonth
  }) : /* @__PURE__ */ React.createElement("span", {
    className: "CalendarDay-yearMonth"
  }), /* @__PURE__ */ React.createElement("div", {
    css: (theme) => dayNumberStyle({
      theme,
      highlight: shouldHighlight,
      weekend,
      showYear
    })
  }, isStartOfMonth && /* @__PURE__ */ React.createElement("span", null, date.get("month"), "/"), /* @__PURE__ */ React.createElement("span", null, day)));
};
var CalendarDayHeader_default = (0, import_react6.forwardRef)(CalendarDayHeader);
...
var useCalendar = (options = {}) => {
  const {
    weeks: numberOfWeeks = 48,
    initialCursor: initialDateCursor = DateTime.now().startOf("week")
  } = options;
  const [cursor2, setCursor] = (0, import_react7.useState)(initialDateCursor.startOf("week"));
  const days = (0, import_react7.useMemo)(() => {
    return [...Array(numberOfWeeks)].reduce((acc, _, weekIndex) => {
      const startOfWeek = cursor2.plus({ weeks: weekIndex });
      const wholeWeek = [...Array(7)].map((_2, dayIndex) => startOfWeek.plus({ days: dayIndex }));
      return [...acc, ...wholeWeek];
    }, []);
  }, [numberOfWeeks, cursor2]);
  const dividedByMonth = (0, import_react7.useMemo)(() => chunk(days, 7).reduce((acc, week) => {
    const startOfWeek = week[0];
    const shouldCreateNewMonth = startOfWeek.get("day") === 1 || startOfWeek.plus({ days: 6 }).get("month") !== startOfWeek.get("month");
    if (shouldCreateNewMonth) {
      return [...acc, [...week]];
    }
    const [last3, ...rest] = [acc.pop(), ...acc];
    return [...rest, [...last3 ?? [], ...week]];
  }, []), [days]);
...
var StickyCalendarDayHeader = ({ scrollContainerId, ...props }, ref) => {
  const calendarHeaderRef = (0, import_react9.useRef)(null);
  const [node2, setNode] = (0, import_react9.useState)(null);
  const observer = (0, import_react9.useRef)(null);
  (0, import_react9.useEffect)(() => {
    ...
    observer.current = new window.IntersectionObserver(([entry]) => {
      ...
      if (calendarHeaderRef.current) {
        calendarHeaderRef.current.style.fontSize = `${24 - entry.intersectionRatio * 8}px`;
        calendarHeaderRef.current.style.setProperty("--day-opacity", `${entry.intersectionRatio < 0.8 ? 0 : 1}`);
      }
    }, {
      root: scrollContainerId ? document.querySelector(`#${scrollContainerId}`) : null,
      rootMargin: "-29px",
      threshold: [
        ...Array(100).fill(0).map((_, i) => (i + 1 * 1) / 100)
      ]
    });
    const { current: currentObserver } = observer;
    if (node2) {
      currentObserver.observe(node2);
      calendarHeaderRef.current = node2;
    }
    return () => currentObserver.disconnect();
  }, [node2, scrollContainerId]);
  return /* @__PURE__ */ React.createElement(CalendarDayHeader_default, {
    ref: setNode,
    css: css`
        grid-row: 1 / 2;
        position: sticky;
...
var StickyCalendarDayHeader_default = (0, import_react9.forwardRef)(StickyCalendarDayHeader);

// src/components/Calendar/CalendarHeader.tsx
var rootStyle2 = css`
  background-color: white;
`;
var dateContainerStyle = css`
  display: flex;
...
var Calendar = (props) => {
  const today = DateTime.now().startOf("day");
  const [{ months: months2 }, setCursor] = useCalendar_default({
  ...
  return /* @__PURE__ */ React.createElement("div", {
    ...
    css: headerStyle
  }, /* @__PURE__ */ React.createElement(CalendarHeader_default, null, "Mon"), /* @__PURE__ */ React.createElement(CalendarHeader_default, null, "Tue"), /* @__PURE__ */ React.createElement(CalendarHeader_default, null, "Wed"), /* @__PURE__ */ React.createElement(CalendarHeader_default, null, "Thu"), /* @__PURE__ */ React.createElement(CalendarHeader_default, null, "Fri"), /* @__PURE__ */ React.createElement(CalendarHeader_default, {
    weekend: true
  }, "Sat"), /* @__PURE__ */ React.createElement(CalendarHeader_default, {
    weekend: true
  }, "Sun")), months2.map((days) => /* @__PURE__ */ React.createElement("div", {
    ...
    return i === 0 ? /* @__PURE__ */ React.createElement(import_react12.Fragment, {
      key: day.toSeconds()
    }, /* @__PURE__ */ React.createElement(StickyCalendarDayHeader_default, {
      date: day,
      weekend: isWeekend,
      scrollContainerId: SCROLL_CONTAINER_ID
    }), /* @__PURE__ */ React.createElement(CalendarDay_default, {
      key: day.toSeconds(),
      date: day,
      css: css`
                    grid-row: 2 / 3;
      ...
      key: day.toSeconds(),
      date: day
    }, /* @__PURE__ */ React.createElement(CalendarDayHeader_default, {
      date: day,
      weekend: isWeekend
    }));
  }))));
...
// src/components/Calendar/Calendar.stories.tsx
var Calendar_stories_default = {
  component: Calendar_default,
  parameters: {
...
var Standard = {
  render: (args) => /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(Calendar_default, {
    css: css`
          max-height: 100vh;
